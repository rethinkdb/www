...
We’re also really excited about the [Slack group](http://slack.rethinkdb.com/)
for the RethinkDB dev community. We launched the group a month ago as an
experiment, and it's growing quiclly and has become an indispensable part of
the community.
...
[![Slack Status](http://slack.rethinkdb.com/badge.svg)][slack]
