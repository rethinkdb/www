...
geolocation stuff, authetnication, security, all these things." He said. "As
...
choose to self-host, but RethinkDB will also offer a cloud service called
Horizon Ops with managed deployments.
