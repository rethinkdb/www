...
- First JSON-pushing open-source scalable database exposes new database access model
...
"RethinkDB has been easy to use and scale. It's great to have confidence that once your data is written you can be sure it can be read," said Karl Grzeszczak, senior software engineer, Mediafly. "From installation to configuration to administration to usage, RethinkDB lets us forget about data headaches and focus on building value."
...
"Modern marketplaces, streaming analytics apps, multiplayer games and collaborative web and mobile apps require sending data directly to the client in realtime," said Slava Akhmechet, CEO of RethinkDB. "For this reason, RethinkDB has engineered a new approach to its database that makes it possible for many more developers to harness the power of the realtime web."
